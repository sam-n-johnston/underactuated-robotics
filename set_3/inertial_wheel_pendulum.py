...
class InertialWheelPendulum(VectorSystem):
    ...
    def GetLinearizedDynamics(self, u_f, x_f):
        ...
        lengthAndMass = self.l1 * self.m1 + self.l2 * self.m2
        lengthAndMassSquared = pow(self.l1, 2) * self.m1 + pow(self.l2,2) * self.m2
        lengthAndMassSquaredI1 = self.I1 + lengthAndMassSquared
